...
class BaseProblem(object):
    ...
    def plot2d(self, points=100, sol=[], figure=None, figsize=(12, 8), contour=True, contour_levels=20,imshow_kwds=None, contour_kwds=None):
        ...
        ## if sol is given, plot them
        if len(sol):
            plt.plot(sol[0],sol[1],'gD')
            plt.text(sol[0],sol[1],f"BEST SOL")
